...
class Insurance_Portfolio():
    ...
    def Replicating_Portfolio(self, Y_paths, B, n_time_steps_Y, Payoff_Y, out_of_money_P, S, local=False):
        ...
        const_initalizer = keras.initializers.RandomNormal(mean=[1-out_of_money_P,self.out_of_money_P], stddev=0.0, seed=1234)
